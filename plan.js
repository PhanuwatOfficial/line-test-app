...
แก้ไขหน้า printmemo ให้ส่วนลายเซ็นอยู่ด้านล่างเสมอ และรูปลายเซ็นให้ไม่แสดงผลทับ memo-content (รูปต้องไม่ทับตัวหนังสือ)

พยายามให้อยู่ใน1หน้า โดยมีลายเซ็นอยู่ด้านล่าง ถ้าเกิน1หน้า ให้ลดขนาด font ส่วน memo-content (ลดอัตโนมัติ)

ยกเว้นไฟล์แนบ/เอกสารแนบ/รูป ให้แสดงผลหน้าถัดไปได้เลยถ้ายาวเกิน
